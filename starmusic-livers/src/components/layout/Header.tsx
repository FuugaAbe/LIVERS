          ...
          <div className="fixed top-4 right-4 w-64 bg-white z-50 shadow-xl rounded-lg">
            <div className="p-4">
              ...
              <div className="flex items-center justify-end mb-4">
                <button
                  onClick={() => setIsMenuOpen(false)}
                  className="w-12 h-12 flex items-center justify-center text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-full transition-all"
                  aria-label="メニューを閉じる"
                >
                  <div className="relative w-5 h-5">
                    <div className="absolute w-5 h-0.5 bg-gray-500 rotate-45 top-2"></div>
                    <div className="absolute w-5 h-0.5 bg-gray-500 -rotate-45 top-2"></div>
                  </div>
                </button>
              </div>
